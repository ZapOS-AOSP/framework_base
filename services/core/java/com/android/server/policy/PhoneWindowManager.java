...
import com.android.internal.util.zap.ZapUtils;
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private String mRingerToggleChord = ZAP_VOLUME_HUSH_OFF;
    ...
    private void handleRingerChordGesture() {
        if (mRingerToggleChord == null ||
                mRingerToggleChord.equals(ZAP_VOLUME_HUSH_OFF)) return;
                    ...
                    boolean preCondition() {
                        switch (mPowerVolUpBehavior) {
                            case POWER_VOLUME_UP_BEHAVIOR_MUTE:
                                return mRingerToggleChord != ZAP_VOLUME_HUSH_OFF;
                            default:
                                return true;
                        }
                    }
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            if (!mContext.getResources()
                ...
                mRingerToggleChord = ZAP_VOLUME_HUSH_OFF;
            }
    ...
    public void sendCustomAction(Intent intent) {
        ...
        if (action != null) {
            if (ZapUtils.INTENT_SCREENSHOT.equals(action)) {
                interceptScreenshotChord(TAKE_SCREENSHOT_FULLSCREEN, SCREENSHOT_KEY_OTHER, 0);
            } else if (ZapUtils.INTENT_REGION_SCREENSHOT.equals(action)) {
